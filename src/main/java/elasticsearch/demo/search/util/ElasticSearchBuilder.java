package elasticsearch.demo.search.util;

import elasticsearch.demo.common.constants.AppConstants;
import elasticsearch.demo.common.constants.PageConstants;
import elasticsearch.demo.exception.ValidateException;
...
public class ElasticSearchBuilder {
    ...
    private static SearchSourceBuilder searchSourceBuilder(Object requestDTO, QueryBuilder queryBuilder) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
    ...
    private static QueryBuilder getMatchPhrasePrefixQuery(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
    ...
    private static QueryBuilder getMatchPhraseQuery(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
        if (searchRequestDTO == null) {
            return null;
        }
    ...
    private static QueryBuilder getRegexpQueryBuilder(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
    ...
    private static QueryBuilder getFuzzyQueriesBuilder(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
        if (searchRequestDTO == null){
            return null;
        }
    ...
    private static QueryBuilder getWildCardQueryBuilder(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
    ...
    private static QueryBuilder getBoostingQueryBuilder(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
        if (searchRequestDTO == null){
            return null;
        }
    ...
    private static QueryBuilder getMultiFieldQueryBuilder(Object requestDTO) {
        SearchRequestDTO searchRequestDTO = (SearchRequestDTO) requestDTO;
        if (searchRequestDTO == null){
            return null;
        }
